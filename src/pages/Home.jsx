...
function Contact() {
  ...
  const whatsappMessage = encodeURIComponent("Hello, I am interested in your villa plots.");
  const whatsappUrl = `https://wa.me/${whatsappNumber}?text=${whatsappMessage}`;

  return (
    <section id="contact" className="contact-section">
      <div className="container contact-grid">
        <div className="contact-left animate-fade-in">
        ...
        <div className="contact-card animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <h3 style={{ marginBottom: '1.5rem', color: '#1a1a1a', fontSize: '1.5rem' }}>Chat with us directly</h3>
          <p style={{ color: '#666', marginBottom: '2rem', lineHeight: '1.5' }}>
            Skip the forms. Click the button below to reach out to us directly on WhatsApp for immediate assistance.
          </p>
          <a 
            href={whatsappUrl} 
            target="_blank" 
